...
/**
 * 二次探测 i =（base + step * step）％M
 * @author wayne
 * @version QuadraticProbingHashMap
 */
public class QuadraticProbingHashMap {
    ...
    public static void main(String[] args) {
        QuadraticProbingHashMap quadraticProbingHashMap= new QuadraticProbingHashMap();
        quadraticProbingHashMap.insertNode(20,20);
        quadraticProbingHashMap.insertNode(50,50);
        quadraticProbingHashMap.insertNode(100,100);
        quadraticProbingHashMap.display();
    }
